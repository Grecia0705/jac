...
class RawmatterModel extends BaseModel_1.default {
    constructor() {
        super();
    }
    Create(_a) {
    ...
    CountAll() {
        return __awaiter(this, void 0, void 0, function* () {
            this.StartPrisma();
            const result = yield this.prisma.rawmater.count();
            this.DistroyPrisma();
            return result;
        });
    }
    ...
    GetPagination(_a) {
        return __awaiter(this, arguments, void 0, function* ({ pag, limit }) {
            this.StartPrisma();
            const result = yield this.prisma.rawmater.findMany({
                where: {
                    delete_at: false,
                },
                include: {
    ...
    GetById(_a) {
        return __awaiter(this, arguments, void 0, function* ({ id }) {
            this.StartPrisma();
            const result = yield this.prisma.rawmater.findFirst({
                where: {
                    rawmatterId: id,
                    delete_at: false,
                },
...
exports.default = new RawmatterModel();
