/*
  ...
  - You are about to drop the column `kg_gr` on the `Control` table. All the data in the column will be lost.
...
INSERT INTO "new_Control" ("controlId", "createId", "date", "gr", "kg", "machineId", "peso", "productId", "rawmatterId", "sello") SELECT "controlId", "createId", "date", "gr", "kg", "machineId", "peso", "productId", "rawmatterId", "sello" FROM "Control";
DROP TABLE "Control";
